<?php ob_start();
$fromemail="Chris Slay <ceslay@gmail.com>"; // change here if you want
$toemail="ceslay@gmail.com";   // change here if you want
$sub="[Remembering Nancy] Email contact";          // change here if you want
$success_page_name="contact-thanks.html";
